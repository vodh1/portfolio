			...
			<div className='container mx-auto px-4'>
				...
				<div className='flex justify-center'>
					<div
						...
						className='cursor-pointer w-full max-w-md relative group'
					>
						...
						<CardContainer className='w-full'>
							<CardBody className='bg-gray-900 relative group/card dark:hover:shadow-2xl dark:hover:shadow-purple-500/[0.1] dark:border-white/[0.1] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6'>
								...
								>
									A comprehensive course covering React fundamentals, advanced
									patterns, and modern best practices for building interactive
									web applications.
								</CardItem>
				...
				>
					...
					<p className='max-w-2xl mx-auto text-gray-400'>
						...
						workshops, and self-directed learning. Currently exploring advanced
						React patterns, machine learning basics, and cloud computing.
					</p>
				</motion.div>
			</div>
		</section>
